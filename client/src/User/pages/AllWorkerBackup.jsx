      ...
      <section className="filter-bar">
        <Container className="filter-bar-contianer">
          <Row className="d-flex justify-content-center mt-5 align-items-center">
            ...
            <Col md={6} >
              <SearchBar setFilterList={setFilterList} filterList={Worker} count={count} setCount={setCount} setSearchWord={setSearchWord} searchWord={searchWord}/> 
            </Col>
            <Col md={4}>
        ...
        <Container>
        <AllWorkerList productItems={filterList} role={role} selectedOption={selectedOption} searchWord={searchWord}/>
